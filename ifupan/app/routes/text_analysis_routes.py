...
def analyze():
    with get_db() as db:
        ...
        result = TextAnalysisService.analyze_and_save(db, text, prompt_type)
...
def get_analysis_by_id(analysis_id):
    with get_db() as db:
        result = TextAnalysisService.get_analysis_by_id(db, analysis_id)
        if result:
...
def get_all_analyses():
    with get_db() as db:
        ...
        results = TextAnalysisService.get_all_analyses(db, skip, limit)
